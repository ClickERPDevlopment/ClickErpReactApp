  ...
  return (
    <>
      <tr style={{ fontSize: "12px" }} className="font-light">
        ...
        <td className="border border-gray-950 p-0.5">{data[0]?.IMPORT_TYPE}</td>
        ...
        <td className="border border-gray-950 p-0.5">{blncCtn.toFixed(2)}</td>
        <td className="border border-gray-950 p-0.5">{blncKg.toFixed(2)}</td>
      </tr>
    </>
  );
}
