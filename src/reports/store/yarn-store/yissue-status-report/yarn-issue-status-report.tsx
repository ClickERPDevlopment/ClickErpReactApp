                ...
                <tbody>
                    {
                        unique.map((s) => {
                            return (
                                <>
                                    <tr>
                                        <td className='border border-gray-600 p-1 text-center font-bold text-base bg-gray-300' colSpan={15}>{s}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td className='border border-gray-600 p-1 text-center font-bold' colSpan={11}>Total {s}</td>
                                        ...
                                        <td className='border border-gray-600 p-1 text-center' colSpan={3}></td>
                                    </tr>
                                </>
                            );
                        })
