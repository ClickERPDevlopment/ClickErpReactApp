  ...
  return (
    <>
      <tr style={{ fontSize: "12px" }} className="">
        <td className="border border-gray-950 p-0.1">{moment(data[0]?.RCV_CHALLAN_DATE).format("DD-MMM-YY")}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.BUYER}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.WORK_ORDER_NO}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.SUPPLIER}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.FABRIC}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.LC_NO}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.RCV_CHALLAN}</td>
        <td className="border border-gray-950 p-0.1">{challanQty.toFixed(2)}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.UOM}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.RATE}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.CURRENCYCODE}</td>
        <td className="border border-gray-950 p-0.1">{value.toFixed(2)}</td>
        <td className="border border-gray-950 p-0.1">{rollQty.toFixed(2)}</td>
      </tr>
    </>
  );
}
