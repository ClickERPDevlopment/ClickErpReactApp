...
export default function TableTotalRow({ data, title }: { data?: IFinishFabricStockReport[], title?: string }) {
    return (
        <tr className="bg-emerald-200 font-bold">
            <td className="text-xs border border-black p-2 min-w-24 text-center" colSpan={8}>{title ?? 'Total'}</td>
