...
function ReportGroup({ data, firstHeader }: { data: IAccessoriesReceiveReturnChallanGatePassReport[], firstHeader: string[] | null }) {
    ...
    const totalReturnQty = data.reduce((prev, curr) => prev + curr.CHALLAN_QTY, 0);
            ...
            <table className='border-collapse border border-gray-300  w-[100%]'>
                ...
                <tbody>
                    ...
                    <tr className='text-center font-bold'>
                        <td className='border border-gray-300 p-1' colSpan={4}>Total</td>
