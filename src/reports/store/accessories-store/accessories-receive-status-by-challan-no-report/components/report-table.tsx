    ...
    <>
      {data.map((item, index) => (
        <tr key={index} className="text-center">
          ...
          <td className="border border-gray-300 p-1">{item.DESCRIPTION_1}</td>
          <td className="border border-gray-300 p-1">{item.DESCRIPTION_2}</td>
        </tr>
      ))}
    </>
  );
