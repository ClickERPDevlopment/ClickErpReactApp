    ...
    return (
        <>
            <tr className={cn("border-t border-gray-500", ((key % 2) == 0 ? 'bg-emerald-100' : ''))}>
                ...
                <th className="border border-gray-500 text-wrap text-center p-1 max-w-28">{data?.STYLENO}</th>
                <th className="border border-gray-500 text-wrap text-center p-1 max-w-24">{data?.PO_NO}</th>
