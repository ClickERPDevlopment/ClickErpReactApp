...
export default function AccReportHeader({ masterData, seasons }: { masterData: iaccWorkOrder | null, seasons: string }) {
    return (
            ...
            <div className='lg:w-[50%]'>
                <ul>
                    ...
                    <li className='flex'>
                        ...
                        <span className='p-1 text-sm'>: {moment(masterData?.ISSUE_DATE).format("D MMM YY")}</span>
                    </li>
                    <li className='flex'>
                        ...
                        <span className='p-1 text-sm'>: {moment(masterData?.DELIVERY_DATE).format("D MMM YY")}</span>
                    </li>
                    <li className='flex'>
            ...
            <div className='sm:mt-2 lg:w-[50%]'>
                <ul>
                    ...
                    <li className='flex'>
                        ...
                        <span className='p-1 text-sm'>: {masterData?.SUPPLIER_MOBILE_NO}</span>
                    </li>
                    <li className='flex'>
                        <div className='p-1 min-w-40 font-bold text-sm'>
                            <span>SUPPLIER ADDRESS</span>
                        </div>
                        <span className='p-1 text-sm'>: {masterData?.SUPPLIER_ADDRESS}</span>
                    </li>
                    <li className='flex'>
                        <div className='p-1 min-w-40 font-bold text-sm'>
                            <span>SEASON</span>
