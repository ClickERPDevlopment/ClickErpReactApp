...
function ReportHeader({ masterData, searchParams }: { masterData: iaccWorkOrder | null, searchParams: { currency: string } }) {
    return (
        <div>
            <div className=''>
                ...
                <h1 className='font-bold text-2xl text-center'>{masterData?.COMPANY_NAME}</h1>
                <h4 className='font-bold text-base text-center'>{masterData?.COMPANY_ADDRESS}</h4>
                <h4 className='font-bold text-base text-center mt-2'>Block Accessories Report</h4>
            </div>
                ...
                <tr>
                    <td className='border border-gray-300 p-0'>
                        <table className='w-[100%] m-0'>
                            ...
                            <tr className='border-b border-gray-300'>
                                <td className='px-1 border-r border-gray-300'>Factory Address: </td>
                            ...
                            <tr className='border-b border-gray-300'>
                                <td className='px-1 border-r border-gray-300'>Contact Person Name: </td>
                    ...
                    <td className='border border-gray-300 p-0'>
                        <table className='w-[100%] m-0'>
                            ...
                            <tr className='border-b border-gray-300'>
                                <td className='px-1 border-r border-gray-300'>Delivery Date: </td>
                                <td className='px-1'>{masterData?.DELIVERY_DATE ? moment(masterData?.DELIVERY_DATE).format("D MMM YY") : ""}</td>
                            </tr>
                            <tr className='border-b border-gray-300'>
                                <td className='px-1 border-r border-gray-300'>Contact Person Name: </td>
            ...
            <div><p className='text-right font-semibold'>Currency: {searchParams.currency}</p></div>
        </div>
    )
}
