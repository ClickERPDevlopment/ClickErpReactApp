...
const FormSchema = z.object({
  buyerId: z
    ...
    .optional()
    .default(0),
  styleId: z.number().optional().default(0),
  itemId: z.number().optional().default(0),
  workOrderId: z.number().optional().default(0),
  onlyBalanceQtyItemwillshow: z.boolean().default(true).optional(),
});
