      ...
      <table className="w-full text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="text-start"><span className='pb-1 border-t border-gray-900 px-2'>Sr. Executive (IE)</span></td>
            <td className="text-end"><span className='pb-1 border-t border-gray-900 px-2'>Head Of IE</span></td>
