...
function ReportGrandTotal({ data, firstHeader }: { data: IProcessWiseDyeingFinishProductionReport[], firstHeader: string[] | null }) {
    ...
    return (
        <>
            ...
            <td className='border border-gray-300 p-1'>{isNaN(total) ? 0 : total?.toFixed(2)}</td>
        </>
    )
}
