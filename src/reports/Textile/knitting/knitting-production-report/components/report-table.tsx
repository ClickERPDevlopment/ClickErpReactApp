...
function ReportTable({
  ...
  // function groupBy(data: KnittingProductionReportType[]): IGroupedData {
  //   return data.reduce((result: IGroupedData, item) => {
  //     const dateKey = moment(item.PRODUCTION_DATE).format("DD-MMM-YY");
  //     const companyKey = item.INTER_COMPANY || "Unknown";
  ...
  //     if (!result[dateKey].INTER_COMPANY[companyKey]) {
  //       result[dateKey].INTER_COMPANY[companyKey] = {
  //         IN_HOUSE_PROD: 0,
  //         OUTSIDE_PROD: 0,
  //       };
  //     }

  //     result[dateKey].INTER_COMPANY[companyKey].IN_HOUSE_PROD += inHouseProduction;
  //     result[dateKey].INTER_COMPANY[companyKey].OUTSIDE_PROD += outsideProduction;

  //     result[dateKey].TOTAL_PROD += (inHouseProduction + outsideProduction);
  //     result[dateKey].IN_HOUSE_PROD += (inHouseProduction);
  //     result[dateKey].TOTAL_PROD += (outsideProduction);
