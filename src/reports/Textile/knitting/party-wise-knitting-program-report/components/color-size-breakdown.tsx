...
function ColorSizeBreakdown({ data, fabricPart }: { data: PartyWiseKnittingProgramType[], fabricPart: string }
) {

    const uniqueKeys: Set<string> = new Set();

    function groupBy(data: PartyWiseKnittingProgramType[], keys: string[]) {
