...
function Report({ data, searchParams }: { data: IGarmentsDispatchDetailsReportDto[], searchParams: { toDate: any, fromDate: any } }) {
    ...
    //set table header 
    var firstHeader = ["Date", "Challan No.", "Buyer", "Style", "Item", "PO", "Color", "Size", "Dispatch Qty.", "Dispatch Reason", "Send To", "Remarks"];
