...
function ReportGroup({ data, firstHeader }: { data: IShortShipmentReasonStatus[], firstHeader: string[] | null }) {
            ...
            <table className='border-collapse border border-gray-300  w-[100%]'>
                ...
                <tbody>
                    ...
                    <tr className='text-center bg-sky-200'>
                        <td className='border border-gray-300 p-1 font-bold' colSpan={2}>Grand Total</td>
                        ...
                        <td className='border border-gray-300 p-1'>{totalShortExcessQty}</td>
