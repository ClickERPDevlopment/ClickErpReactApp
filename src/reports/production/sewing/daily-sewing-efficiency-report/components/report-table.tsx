  ...
  return (
    <>
      ...
      <tr style={{ fontSize: "13px", backgroundColor: "#c4f2dc" }} className="font-bold">
        ...
        <td className="border border-gray-950 p-0.1 text-center text-nowrap">{((avgWorkHour / 60) / (totalOperator + totalHelper))?.toFixed(2)}</td>
        <td className="border border-gray-950 p-0.1 text-center text-nowrap">{(totalEarneMin * 100 / totalAvailableMin)?.toFixed(2)} %</td>
