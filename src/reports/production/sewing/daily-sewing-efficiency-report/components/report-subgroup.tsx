  ...
  return (
    <>
      <tr style={{ fontSize: "13px" }}>
        {
          index == 0 && <td rowSpan={groupLength} className="border border-gray-950 p-0.1">{data[0]?.LINENAME}</td>
        }
        <td className="border border-gray-950 p-0.1">{data[0]?.BUYERNAME}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.STYLENO}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.ITEMTYPE}</td>
        <td className="border border-gray-950 p-0.1">{data[0]?.SMVSEWING}</td>
        {
          index == 0 && <td rowSpan={groupLength} className="border border-gray-950 p-0.1 text-center">{data[0]?.OPERATOR}</td>
        }

        {
          index == 0 && <td rowSpan={groupLength} className="border border-gray-950 p-0.1">{data[0]?.HELPER}</td>
        }

        {
          index == 0 && <td rowSpan={groupLength} className="border border-gray-950 p-0.1 text-center">{data[0]?.HELPER + data[0]?.OPERATOR}</td>
        }

        {
          index == 0 && <td rowSpan={groupLength} className="border border-gray-950 p-0.1 text-center">{Math.round(data[0]?.TOTALTARGET / data[0]?.ACTUALHOURS)}</td>
        }
        {
          index == 0 && <td rowSpan={groupLength} className="border border-gray-950 p-0.1 text-center">{Math.round(data[0]?.TOTALTARGET)}</td>
        }
        ...
        {
          index == 0 && <td rowSpan={groupLength} className="border border-gray-950 p-0.1 text-center">{(data[0]?.RUNNING_HOUR).toFixed(2)}</td>
        }
