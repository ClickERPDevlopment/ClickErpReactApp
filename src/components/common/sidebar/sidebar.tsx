...
const Sidebar = ({ local_varaiable, ThemeChanger }: { local_varaiable: any, ThemeChanger: any }) => {
  ...
  function slideRight() {
    ...
    if (menuNav && mainContainer1) {
      ...
      const element1: any = document.querySelector(".main-menu > .slide.open > ul");
      if (element) {
  ...
  function setSubmenu(event: any, targetObject: any, MENUITEMS: any = menuitems) {
    const theme = store.getState();
  ...
  //
  function toggleSidemenu(event: any, targetObject: any, MENUITEMS: any = menuitems) {
      ...
      <aside className="app-sidebar" id="sidebar" onMouseEnter={() => Onhover()}
        ...
        <div className="main-sidebar-header">
          <a href={`${import.meta.env.BASE_URL}dashboards/crm/`} className="header-logo">
            <h4 className='text-white'>CLICK</h4>
