...
export const HorizontalClick = (actionfunction: any) => {
    ...
    closeMenuFn();
    const Sidebar = document.querySelector(".main-menu") as HTMLElement | null;
    if (Sidebar) {
...
export const Defaultmenu = (actionfunction: any) => {
    ...
    var icon = document.getElementById("switcher-default-menu") as HTMLInputElement | null;
    if (icon) {
        icon.checked = true
    }
...
export const iconOverayFn = (actionfunction: any) => {
    ...
    localStorage.removeItem("ynexnavstyles");
    var icon = document.getElementById("switcher-icon-overlay") as HTMLInputElement | null;
    if (icon) {
        icon.checked = true
    }
    const MainContent = document.querySelector(".main-content");
...
const Themeprimarycolor = ({ actionfunction }: { actionfunction: any }) => {
    const theme = store.getState();
