          ...
          >
            ...
            <div>
              ...
              <div className="px-4 text-secondary text-xs">
                <b className="me-2 inline-flex">Note:</b>Works same for both
            ...
            <div className=" sidemenu-layout-styles">
              ...
              <div className="px-4 text-secondary text-xs">
                <b className="me-2 inline-flex">Note:</b>Navigation menu styles
                won't work here.
              </div>
            </div>
            <div>
          ...
          >
            <div className="theme-colors">
              ...
              <div className="px-4 text-[#8c9097] dark:text-white/50 text-[.6875rem]">
                <b className="me-2 inline-flex">Note:</b>If you want to change
              ...
              <div className="flex switcher-style space-x-3 rtl:space-x-reverse flex-wrap gap-3">
                <div className="ti-form-radio switch-select">
                  <input
                    ...
                    name="theme-images"
                    id="switcher-bg-img"
                    checked={local_varaiable.bgImg == "bgimg1"}
                    onChange={(_e) => {}}
                ...
                <div className="ti-form-radio switch-select">
                  <input
                    ...
                    name="theme-images"
                    id="switcher-bg-img1"
                    checked={local_varaiable.bgImg == "bgimg2"}
                    onChange={(_e) => {}}
                ...
                <div className="ti-form-radio switch-select">
                  <input
                    ...
                    name="theme-images"
                    id="switcher-bg-img2"
                    checked={local_varaiable.bgImg == "bgimg3"}
                    onChange={(_e) => {}}
                ...
                <div className="ti-form-radio switch-select">
                  <input
                    ...
                    name="theme-images"
                    id="switcher-bg-img3"
                    checked={local_varaiable.bgImg == "bgimg4"}
                    onChange={(_e) => {}}
                ...
                <div className="ti-form-radio switch-select">
                  <input
                    ...
                    name="theme-images"
                    id="switcher-bg-img4"
                    checked={local_varaiable.bgImg == "bgimg5"}
                    onChange={(_e) => {}}
