...
import { GetPrintEmbQuality, PrintEmbQualityMaster } from "@/actions/PrintingEmbroidery/print-emb-quality-action";
import { PrintEmbQualityTable } from "./print-emb-quality-table";
...
function PrintEmbQualityIndex() {
  ...
  const [masterData, setMasterData] = useState<PrintEmbQualityMaster[] | null>(null);
...
export default PrintEmbQualityIndex;
