...
import {
  ...
  Save,
  Update,
} from "@/actions/Merchandising/merch-size-action";
...
const formSchema = z.object({
  ...
  SORTINGNO: z.string().min(1, "Sorting no is required."),
});
...
export default function SizeForm({ data, lstBuyer, pageAction }: NewType) {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      location.pathname.includes("win/")
        ? navigator("/win/merchandising/size")
        : navigator("/dashboard/merchandising/size");
    },
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      SIZENAME: data?.SIZENAME ? data.SIZENAME : "",
      DISPLAY_NAME: data?.DISPLAY_NAME ? data.DISPLAY_NAME : "",
      SORTINGNO: data?.SORTINGNO ? data.SORTINGNO.toString() : "",
    },
  });
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Sorting no" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
